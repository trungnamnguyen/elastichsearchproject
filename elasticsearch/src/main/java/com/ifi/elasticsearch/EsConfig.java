...
//@Configuration
//@EnableElasticsearchRepositories(basePackages = "com.ifi.elasticsearch.repositories")
...
//                .put("cluster.name", "IFISolution-N3").build();
//        TransportClient client = new PreBuiltTransportClient(settings)
//                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("10.225.3.252"), 9200));
//
//// on shutdown
//
////        client.close();
